...
$$
\mathcal{D}_{\text{train}}=\{(s_1,a_1^*),(s_2,a_2^*), \dots \},
$$
...
$$
\begin{equation}
P\left(\pi_\theta(s) \neq \pi^*(s) \mid s\right) \leq \epsilon
\end{equation}
$$
...
$$
P(F=2) = (1-\epsilon)\epsilon
$$

More generally,

$$
P(F=t) = (1-\epsilon)^{t-1}\epsilon
$$
...
$$
J(\pi_\theta)
\leq \sum_{t=1}^{T} \epsilon (T-t+1) = \epsilon \sum_{t=1}^{T}  (T-t+1) =  \epsilon (T + T(-1)\dots 1)= \epsilon\frac{T(T+1)}{2}.
$$

Finally,

$$
J(\pi_\theta) = O(\epsilon T^2)
$$
